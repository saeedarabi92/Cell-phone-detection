...
class Phone_Detector():
    ...
    def feed(self, img, img_name):
        ...
        if self.save_image and self.detected:
            ...
            # img = self.draw_bbox(detections, img)
            img_name = "./data/detection/" + img_name.split('/')[-1]
            print("img_name: ", img_name)
            cv2.imwrite(img_name, img)
            # plt.show()
            # cv2.waitKey(0)
        # print("Done processing_1")
    ...
    def detection_by_color_filtering(self, img):
        ...
        th_g, threshed_r = cv2.threshold(
            blur_r, 40, 255, cv2.THRESH_BINARY_INV)
    ...
    def load_annotation(self):
        f = open("./data/find_phone/labels.txt", 'r')
...
if __name__ == '__main__':
    # test_files = ['./data/find_phone/60.jpg', './data/find_phone/61.jpg']
    ...
    # 33, 125, 5, 47
    #  60, 48, 109, 41
    # print("test_f: ", test_files)
    # test_image = cv2.imread('./datest_images/6.jpg')
